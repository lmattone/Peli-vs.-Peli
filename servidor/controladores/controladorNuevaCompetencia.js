...
module.exports = {
    ...
    postNuevaCompetencia: (req, res) => {
        ...
        if (directorCompetencia && actorCompetencia && generoCompetencia) {
            ...
            sqlParams.push(directorCompetencia, actorCompetencia, generoCompetencia);
            ...
            sql +=  ' LEFT JOIN actor_pelicula as Ap ON P.id = Ap.pelicula_id' +
                    ' WHERE Ap.actor_id = ? AND genero_id = ? ';
